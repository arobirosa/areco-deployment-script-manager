 ...
 *  
 */
package org.areco.ecommerce.deploymentscripts.examples.jalo;
...
import org.areco.ecommerce.deploymentscripts.examples.constants.ArecoDeploymentScriptsExamplesConstants;



/**
 * This is the extension manager of the ArecoDeploymentScriptsExamples extension.
 */
public class ArecoDeploymentScriptsExamplesManager extends GeneratedArecoDeploymentScriptsExamplesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ArecoDeploymentScriptsExamplesManager.class.getName());
	 ...
	 */
	public static ArecoDeploymentScriptsExamplesManager getInstance()
	{
		return (ArecoDeploymentScriptsExamplesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ArecoDeploymentScriptsExamplesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ArecoDeploymentScriptsExamplesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ArecoDeploymentScriptsExamplesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ArecoDeploymentScriptsExamplesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ArecoDeploymentScriptsExamplesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
