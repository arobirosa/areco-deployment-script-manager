 ...
 */
package org.areco.ecommerce.deploymentscripts.hmc.jalo;
...
/**
 * This is the extension manager of the Arecodeploymentscriptshmc extension.
 */
public class ArecodeploymentscriptshmcManager extends GeneratedArecodeploymentscriptshmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(ArecodeploymentscriptshmcManager.class);
	 ...
	 */
	public static ArecodeploymentscriptshmcManager getInstance()
	{
		return (ArecodeploymentscriptshmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ArecodeploymentscriptshmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ArecodeploymentscriptshmcManager() // NOPMD 
	{
		LOG.debug("constructor of ArecodeploymentscriptshmcManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of ArecodeploymentscriptshmcManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of ArecodeploymentscriptshmcManager called, current tenant: {}", getTenant().getTenantID());
	}
