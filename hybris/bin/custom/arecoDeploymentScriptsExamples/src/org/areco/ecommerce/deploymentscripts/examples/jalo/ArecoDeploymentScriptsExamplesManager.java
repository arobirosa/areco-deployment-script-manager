...
public class ArecoDeploymentScriptsExamplesManager extends GeneratedArecoDeploymentScriptsExamplesManager {
    ...
    public static ArecoDeploymentScriptsExamplesManager getInstance() {
        return (ArecoDeploymentScriptsExamplesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
                .getExtension(ArecoDeploymentScriptsExamplesConstants.EXTENSIONNAME);
    }
     ...
     */
    // NOPMD
    public ArecoDeploymentScriptsExamplesManager() {
