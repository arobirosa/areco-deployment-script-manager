...
import org.areco.ecommerce.deploymentscripts.backoffice.constants.ArecodeploymentscriptsbackofficeConstants;
...
public class ArecodeploymentscriptsbackofficeManager extends GeneratedArecodeploymentscriptsbackofficeManager
{
	...
	private static final Logger LOG = Logger.getLogger(ArecodeploymentscriptsbackofficeManager.class.getName());
	 ...
	 */
	public static ArecodeploymentscriptsbackofficeManager getInstance()
	{
		return (ArecodeploymentscriptsbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ArecodeploymentscriptsbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ArecodeploymentscriptsbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ArecodeploymentscriptsbackofficeManager called.");
		}
	}
